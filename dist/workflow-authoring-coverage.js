...
export const WORKFLOW_AUTHORING_FROZEN_FILES = [
    {
        ...
        sha256: "e33e217bcec67f36b12909a16acf6bc555c048153d6fe143f3e2712fc8310c64",
    },
    {
...
const FROZEN_GUIDANCE_BY_CAPABILITY = {
    ...
    "workflow.runtime.checkpoint": [
        {
            path: SPECIALIZED_HELPERS_PATH,
            requiredText: "`checkpoint({ kind, checkpointId, payload })` | Durably suspends the run until a controller attaches a JSON response for that exact ID and resumes it. Works without foreground UI; replay returns the journaled response.",
        },
        {
            path: SPECIALIZED_HELPERS_PATH,
