...
export declare function getProjectModelTierConfigPath(cwd: string): string;
/**
 ...
 */
export declare function loadModelTierConfig(configPathOrOptions?: string | ModelTierConfigOptions): ModelTierConfig | null;
/**
