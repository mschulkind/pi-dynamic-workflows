...
const workflowToolSchema = Type.Object({
    ...
    maxAgents: Type.Optional(Type.Number({
        description: "Agent cap (1000 default; safety). Count: verify=reviewers, judgePanel=entries×judges, completenessCheck=1. Retries add no slots. Lower for dynamic fan-out; large fan-outs need explicit user intent.",
    })),
