...
| `/workflows-progress compact\|detailed\|status\|max <N>` | Live-panel detail level (detailed by default; saved choices override the default) and max agents shown per phase |
